package com.attech.employeemanager.infra.common.rest;

import com.attech.employeemanager.domain.common.exception.BusinessException;
...
public class RestExceptionHandler extends BaseController {
    ...
    public Response<ErrorResponse> handleTicketApiBusinessException(BusinessException ex, Locale locale) {
        return createErrorResponseFromMessageSource(ex.getKey(), locale, ex.getArgs());
    }

    @ExceptionHandler(DataNotFoundException.class)
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public Response<ErrorResponse> handleTicketApiDataNotFoundException(DataNotFoundException ex, Locale locale) {
        return createErrorResponseFromMessageSource(ex.getKey(), locale, ex.getArgs());
    }
